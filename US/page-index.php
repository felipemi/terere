                    ...
                    <ul>
                        <li>
                            <a class="chas-naturais" href="produtos/#tabs-5" alt="chas-naturais">
                                <span class="texto-item" style="padding-left: 62px !important; padding-top: 22px !important; font-size: 23px !important;">Mate Tea and Natural</span>
                            </a>
                        ...
                        <li>
                            <a class="cha-mate" href="produtos/#tabs-6" alt="erva-mate">
                                <span class="texto-item" style="padding-top: 24px !important; padding-left: 133px !important; font-size: 21px !important;">Mate Ice</span>
                            </a>
                        ...
                        <li>
                            <a class="erva-mate" href="produtos/#tabs-4" alt="cha-mate">
                                <span class="texto-item erva" style="padding-left: 94px !important; padding-top: 22px !important; font-size: 23px !important;">Hot mate</span>
