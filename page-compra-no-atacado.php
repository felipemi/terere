...
<div id="primary" class="site-content">
    ...
    <div id="content" role="main" class="compra-atacado">
        ...
        <div class="right-text">
            ...
            <b>Acima de 1.000 reais solicite tabela de preços especiais. </b><br />
            <strong>Envie um e-mail para:</strong> <a href="mailto:falecom@terere.com.br">falecom@terere.com.br</a> e solicite a TABELA DE PREÇOS
        </div>
